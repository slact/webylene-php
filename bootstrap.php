...
{
	if (file_exists(ROOT . DIRECTORY_SEPARATOR . "classes". DIRECTORY_SEPARATOR . $class . ".php"))
		include_once(ROOT . DIRECTORY_SEPARATOR . "classes". DIRECTORY_SEPARATOR . $class . ".php");
	else
